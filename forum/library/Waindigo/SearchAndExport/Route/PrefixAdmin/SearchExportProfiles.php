 ...
 */
class Waindigo_SearchAndExport_Route_PrefixAdmin_SearchExportProfiles implements XenForo_Route_Interface
{
    ...
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        ...
        return $router->getRouteMatch('Waindigo_SearchAndExport_ControllerAdmin_SearchExportProfile', $action,
