...
$data['xf_permission_entry'] = "
	...
	VALUES
		...
		(3, 0, 'forum', 'viewContent', 'allow', 0),
		(3, 0, 'forum', 'viewOthers', 'allow', 0),
		(3, 0, 'forum', 'votePoll', 'allow', 0),
		(3, 0, 'forum', 'like', 'allow', 0),
		(3, 0, 'forum', 'warn', 'allow', 0),
		...
		(3, 0, 'general', 'report', 'allow', 0),
		(3, 0, 'general', 'warn', 'allow', 0),
		(3, 0, 'general', 'viewWarning', 'allow', 0),
		(3, 0, 'general', 'manageWarning', 'allow', 0),
		...
		(4, 0, 'forum', 'viewContent', 'allow', 0),
		(4, 0, 'forum', 'viewOthers', 'allow', 0),
