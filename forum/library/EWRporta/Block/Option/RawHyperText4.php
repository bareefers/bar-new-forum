...
class EWRporta_Block_Option_RawHyperText4
{
	public static function verifyHTML(&$option, XenForo_DataWriter $dw, $fieldName)
	{
		...
		$template = $templateModel->getTemplateInStyleByTitle('EWRblock_RawHyperText4', 0);
	...
	{
		$templateModel = XenForo_Model::create('XenForo_Model_Template');
		$template = $templateModel->getTemplateInStyleByTitle('EWRblock_RawHyperText4.css', 0);
