...
class EWRporta2_Model_Post extends XFCP_EWRporta2_Model_Post
{
	public function getPostsInThread($threadId, array $fetchOptions = array())
	{
		if ($article = $this->getModelFromCache('EWRporta2_Model_Articles')->getArticleByThreadIdOrAuto($threadId))
		{
