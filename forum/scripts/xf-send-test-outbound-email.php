<?php
/**
 * Send a templated message (`contact_email`) so XenForo applies **MAIL_CONTAINER** (header logo + email CSS).
 * ACP’s “Test outbound email” uses raw `setContent` and will not show the logo.
 *
