 ...
 * @property-read CodeEvent|null $Event
 */
class CodeEventListener extends Entity
{
	...
	protected function verifyHint($hint)
	{
		if ($hint === '_')
		{
			$this->error(\XF::phrase('please_enter_valid_value'), 'hint');
			return false;
		}
	...
	protected function _preSave()
	{
		...
		{
			$listener = \XF::em()->getFinder(CodeEventListenerFinder::class)->where([
