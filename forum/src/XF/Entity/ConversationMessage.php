...
class ConversationMessage extends Entity implements ContainableInterface, DatableInterface, LinkableInterface, QuotableInterface, RenderableContentInterface, ViewableInterface
{
	...
	public function canEdit(&$error = null)
	{
		...
		{
			$error = \XF::phraseDeferred('direct_message_is_closed');
			return false;
		}
	...
	public function isFirstMessage(): bool
	{
		...
		// this can be called during an insert, just assume it's the first message
	...
	{
		$route = $canonical ? 'canonical:direct-messages/replies' : 'direct-messages/replies';
		return $this->app()->router('public')->buildLink($route, $this, $extraParams, $hash);
	}

	public function getContentPublicRoute()
	{
		return 'direct-messages/replies';
	}

	public function getContentTitle(string $context = '')
	{
		return \XF::phrase('direct_message_from_x', ['username' => $this->username]);
	}
