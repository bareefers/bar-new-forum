...
class Request
{
	...
	protected function getFileExifData(): array
	{
		...
		return $exifData->getExifDataExtended($tags);
	}
	...
	public function getProtocol()
	{
		...
		$parsedUrl = $this->getBoardUrlData();
		if ($parsedUrl && !empty($parsedUrl['scheme']))
		{
	...
	protected function getBoardUrlData(): ?array
	{
		if (PHP_SAPI !== 'cli')
		{
			return null;
