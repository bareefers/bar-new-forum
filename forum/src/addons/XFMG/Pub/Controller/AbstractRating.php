...
use XFMG\Repository\Rating;
use XFMG\Service\Rating\Rater;
...
abstract class AbstractRating extends AbstractController
{
	 ...
	 * @return Rater
	 */
	protected function setupRatingCreate(Entity $content)
	{
		/** @var MediaItem | Album $content */
		/** @var Rater $rater */
	...
	protected function finalizeRatingCreate(Rater $rater)
	{
