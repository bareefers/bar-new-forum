...
class Category extends AbstractController
{
	...
	protected function getAlbumsInCategoryPaginated(\XFMG\Entity\Category $category, $page = 1, $perPage = null)
	{
		...
		/** @var \XFMG\Entity\Album[]|AbstractCollection $resources */
		$albums = $finder->fetch();
	...
	protected function adjustAlbumListApiResults(\XFMG\Entity\Category $category, EntityResultInterface $result)
	{
	...
	protected function getMediaInCategoryPaginated(\XFMG\Entity\Category $category, $page = 1, $perPage = null)
	{
		...
		/** @var \XFMG\Entity\MediaItem[]|AbstractCollection $resources */
		$media = $finder->fetch();
		if (\XF::isApiCheckingPermissions())
		{
	...
	protected function adjustMediaListApiResults(\XFMG\Entity\Category $category, EntityResultInterface $result)
	{
		$result->skipRelation('Category');
	}
