 ...
 *
 * GETTERS
 * @property-read Album|MediaItem $Content
 * @property-read array|null $GalleryMedia
 * @property-read array|null $GalleryAlbums
 * @property mixed $reactions
 * @property mixed $reaction_users
 *
 * RELATIONS
 * @property-read Album|null $Album
 * @property-read MediaItem|null $Media
 ...
 */
class Comment extends Entity implements LinkableInterface, QuotableInterface, RenderableContentInterface, ViewableInterface
{
	use ReactionTrait;
