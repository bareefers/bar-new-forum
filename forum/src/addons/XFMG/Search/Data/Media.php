...
/**
 * @extends AbstractData<\XFMG\Entity\MediaItem>
 * @implements AutoCompletableInterface<\XFMG\Entity\MediaItem>
 */
class Media extends AbstractData implements AutoCompletableInterface
{
