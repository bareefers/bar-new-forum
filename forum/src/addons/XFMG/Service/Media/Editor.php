...
class Editor extends AbstractService
{
	...
	protected function _save()
	{
		...
		$updateAlbumDate = $mediaItem->album_id && $mediaItem->isChanged('custom_fields');

		$mediaItem->save(true, false);

		if ($updateAlbumDate && $mediaItem->Album)
		{
			$mediaItem->Album->last_update_date = \XF::$time;
			$mediaItem->Album->save(true, false);
		}
