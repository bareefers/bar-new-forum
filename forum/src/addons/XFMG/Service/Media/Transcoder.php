...
class Transcoder extends AbstractService
{
	...
	public function __construct(App $app, TranscodeQueue $queueItem)
	{
		parent::__construct($app);
		$this->setQueueItem($queueItem);
	}

	protected function setQueueItem(TranscodeQueue $queueItem)
	{
	...
	public function transcodeProcess()
	{
		...
		$tempPath = File::copyAbstractedPathToTempFile($filename);
	...
	public function finalizeTranscode($outputFile)
	{
		...
		{
			$preparer = new Preparer($outputFile);
