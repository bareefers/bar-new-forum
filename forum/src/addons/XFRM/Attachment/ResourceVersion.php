...
/**
 * @extends AbstractHandler<\XFRM\Entity\ResourceVersion, array{
...
class ResourceVersion extends AbstractHandler
{
	...
	{
		/** @var \XFRM\Repository\ResourceVersion */
		$resourceVersionRepo = \XF::repository('XFRM:ResourceVersion');
		return $resourceVersionRepo->getVersionAttachmentConstraints();
	}
