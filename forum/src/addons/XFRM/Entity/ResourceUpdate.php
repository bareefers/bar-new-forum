 ...
 */
class ResourceUpdate extends Entity implements RenderableContentInterface, LinkableInterface, ViewableInterface
{
	use BookmarkTrait;
	 ...
	 * @api-out Attachment[] $Attachments <cond> If the update has attachments
	 * @api-out str $message_parsed HTML parsed version of the message
